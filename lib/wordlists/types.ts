...
export const AVAILABLE_WORDLISTS = {
  ...
  uk: {
    wordlist: {
      ...
      name: 'Wordlist',
      description: 'Wordlist (10,870 words)',
      size: 10870,
      hasTransliteration: true,
      isDiceware: false,
    },
    short: {
      path: '/wordlists/uk/short_diceware.txt',
      name: 'Short',
      description: 'Short Diceware (1,296 words)',
      size: 1296,
      dice: 4,
      hasTransliteration: true,
      isDiceware: true,
    ...
    long: {
      path: '/wordlists/uk/long_diceware.txt',
      name: 'Long',
      description: 'Long Diceware (7,776 words)',
      size: 7776,
      dice: 5,
      hasTransliteration: true,
      isDiceware: true,
